...
local function H4Gol(i,v)
	...
	else if v then stats.set_bool_masked("MP"..mpx().."_H4LOOT_CASH_C",false,i)stats.set_bool_masked("MP"..mpx().."_H4LOOT_CASH_C_SCOPED",false,i)end stats.set_bool_masked("MP"..mpx().."_H4LOOT_GOLD_C",v,i)stats.set_bool_masked("MP"..mpx().."_H4LOOT_GOLD_C_SCOPED",v,i)end
end
local function H4Cas(i,v)
	if v==nil then return stats.get_bool_masked("MP"..mpx().."_H4LOOT_CASH_C",i)
	else if v then stats.set_bool_masked("MP"..mpx().."_H4LOOT_GOLD_C",false,i)stats.set_bool_masked("MP"..mpx().."_H4LOOT_GOLD_C_SCOPED",false,i)end stats.set_bool_masked("MP"..mpx().."_H4LOOT_CASH_C",v,i)stats.set_bool_masked("MP"..mpx().."_H4LOOT_CASH_C_SCOPED",v,i)end
end
	
local function H4Cok(i,v)
	if v==nil then return stats.get_bool_masked("MP"..mpx().."_H4LOOT_COKE_I",i)
	else if v then stats.set_bool_masked("MP"..mpx().."_H4LOOT_CASH_I",false,i)
		...
		stats.set_bool_masked("MP"..mpx().."_H4LOOT_COKE_I",v,i)stats.set_bool_masked("MP"..mpx().."_H4LOOT_COKE_I_SCOPED",v,i)end
end
local function H4Cas2(i,v)
	if v==nil then return stats.get_bool_masked("MP"..mpx().."_H4LOOT_CASH_I",i)
	else if v then stats.set_bool_masked("MP"..mpx().."_H4LOOT_COKE_I",false,i)
			stats.set_bool_masked("MP"..mpx().."_H4LOOT_COKE_I_SCOPED",false,i)
			stats.set_bool_masked("MP"..mpx().."_H4LOOT_WEED_I",false,i)
			stats.set_bool_masked("MP"..mpx().."_H4LOOT_WEED_I_SCOPED",false,i)end
		stats.set_bool_masked("MP"..mpx().."_H4LOOT_CASH_I",v,i)stats.set_bool_masked("MP"..mpx().."_H4LOOT_CASH_I_SCOPED",v,i)end
end
local function H4Wee(i,v)
	if v==nil then return stats.get_bool_masked("MP"..mpx().."_H4LOOT_WEED_I",i)
		...
		stats.set_bool_masked("MP"..mpx().."_H4LOOT_WEED_I",v,i)stats.set_bool_masked("MP"..mpx().."_H4LOOT_WEED_I_SCOPED",v,i)end
end
